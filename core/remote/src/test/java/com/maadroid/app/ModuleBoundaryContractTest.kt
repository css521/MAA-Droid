...
class ModuleBoundaryContractTest {
     ...
     */
    private val contractPackage = "com.maadroid.app.engine"
    ...
    private val hostPackages = listOf(
        "com.maadroid.app.presentation.",
        "com.maadroid.app.koin.",
        "com.maadroid.app.schedule.",
        "com.maadroid.app.announcement.",
    ...
    private val arknightsInApp = "com.maadroid.app.maa."
