...
import com.aliothmoon.maadroid.domain.launch.LaunchSource
import com.aliothmoon.maadroid.schedule.model.ScheduleStrategy
import com.aliothmoon.maadroid.schedule.model.ScheduledExecutionRequest
...
object LaunchIntentMapper {
    ...
    fun toShowIntent(context: Context, request: LaunchRequest): Intent {
        return Intent(context, com.aliothmoon.maadroid.MainActivity::class.java).apply {
