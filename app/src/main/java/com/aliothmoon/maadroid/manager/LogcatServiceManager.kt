...
import com.aliothmoon.maadroid.ILogcatService
import com.aliothmoon.maadroid.domain.models.RemoteBackend
import com.aliothmoon.maadroid.remote.LogcatCaptureServiceImpl
...
object LogcatServiceManager {
    ...
    fun bind() {
        ...
        val backend = RemoteAccessCoordinator.configuredBackend()
