package com.maadroid.app.presentation.view.notification
...
import com.maadroid.app.data.notification.WEBHOOK_PRESET_TEMPLATES
import com.maadroid.app.data.notification.withWebhookPreset
...
private fun ProviderConfig(
    id: String,
    settings: com.maadroid.app.data.notification.NotificationSettings,
