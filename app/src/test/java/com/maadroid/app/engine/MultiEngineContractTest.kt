...
import com.maadroid.app.engine.limbus.LimbusEngineProvider
import com.maadroid.app.engine.limbus.LimbusProfile
...
class MultiEngineContractTest {
    ...
    fun defaultGameIsArknightsSoUpgradingUsersStayPut() {
        ...
        assertEquals(
            EngineIds.ARKNIGHTS,
            com.maadroid.app.domain.models.AppSettings().currentGameId,
        )
    }
}
