...
import com.aliothmoon.maadroid.manager.ShizukuSpawner
...
class ShizukuProcessPathContractTest {
    ...
    fun bindUserServiceStackIsGone() {
        val offenders = TestSources.resolveDir("src/main/java/com/aliothmoon/maadroid/manager")
            .walkTopDown()
    ...
    fun managerTimeoutsFollowConnector() {
        val source = TestSources.resolve("src/main/java/com/aliothmoon/maadroid/manager/RemoteServiceManager.kt").readText()
        assertTrue(
    ...
    fun remoteServiceConstructorStaysLightweight() {
        val source = TestSources.resolve("src/main/java/com/aliothmoon/maadroid/remote/RemoteServiceImpl.kt").readText()
